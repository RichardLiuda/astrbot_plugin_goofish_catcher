...
def build_worker_settings_from_env() -> PluginSettings:
    ...
    return PluginSettings(
        ...
        default_pages=1,
        max_pages=max(1, _cfg_int(config, "max_pages", "GOOFISH_WORKER_MAX_PAGES", 8)),
        ...
        max_retries=max(0, _cfg_int(config, "max_retries", "GOOFISH_WORKER_MAX_RETRIES", 3)),
        retry_base_sec=max(1, _cfg_int(config, "retry_base_sec", "GOOFISH_WORKER_RETRY_BASE_SEC", 30)),
        retry_max_sec=max(5, _cfg_int(config, "retry_max_sec", "GOOFISH_WORKER_RETRY_MAX_SEC", 900)),
